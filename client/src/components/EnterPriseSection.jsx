          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-black">
                Join BMU Makeup Studio & Academy to unlock your full potential in makeup artistry, with courses designed by industry experts.
              </p>
                ...
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-black">
                    <svg
                      ...
                      fill="currentColor"
                      aria-hidden="true"
                      className="absolute left-1 top-1 h-5 w-5 text-black -600"
                    >
                  ...
                  <dd className="inline">
                    Learn the latest techniques in makeup artistry with our industry-recognized courses and hands-on training.
                  </dd>
                </div>
                <div className="relative pl-9">
                  ...
                  <dd className="inline">
                    Get real-world experience with hands-on training, guided by our expert faculty in a professional environment.
                  </dd>
                </div>
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-gray-900">
                  ...
                  <dd className="inline">
                    Gain exposure to the beauty industry with our comprehensive curriculum and industry-standard products.
                  </dd>
                </div>
              </dl>
            </div>
