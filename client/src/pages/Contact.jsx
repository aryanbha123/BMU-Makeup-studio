...
export default function Contact() {
    return (
        <div>
            ...
            <div class="lg:px-20 px-5   mt-6 mb-20 font-[sans-serif]">
                ...
                <div class="grid lg:grid-cols-3 items-start justify-items-stretch gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                    ...
                    <div class="bg-[#011c2b]  rounded-lg p-6 h-full max-lg:order-1">
                        ...
                        <p class="text-sm text-gray-300 mt-4">Have some queries or want to ask something more, don't worry we are ready to help just make a call or email us.</p>
                        ...
                        <ul class="mt-16 space-y-8">
                            ...
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-white text-sm  ml-4">
                                    BMU Makeup Studio near GMS Road, Seema Dwar, Dehradun, Uttarakhand 248146
                                </a>
                            </li>
                        </ul>
                            ...
                            <div class="grid sm:grid-cols-2 gap-8">
                                <div class="relative flex items-center">
                                    <input type="text" placeholder="First Name"
                                        class="px-2 py-3 bg-transparent w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none" />
                                ...
                                <div class="relative flex items-center">
                                    <input type="number" placeholder="Phone No."
                                        class="px-2 py-3 bg-transparent text-black w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none" />
                                ...
                                <div class="relative flex items-center sm:col-span-2">
                                    <textarea placeholder="Write Message"
                                        class="px-2 pt-3 bg-transparent text-black w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none"></textarea>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2"
                                        viewBox="0 0 682.667 682.667">
                                        <defs>
                                            <clipPath id="a" clipPathUnits="userSpaceOnUse">
