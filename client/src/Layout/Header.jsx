                    ...
                    <div className="lg:flex hidden  justify-between px-12">
                        ...
                        <div className="flex-1 relative flex flex-col items-end mt-20 gap-2  text-6xl">
                            ...
                            <div className='gap-5 flex absolute bottom-28' >
                                <button className="rounded-md bg-black -600 px-3.5 py-2.5 text-lg font-semibold text-white shadow-lg hover:bg-black -500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black -600 hover:text-button-300 transition-all duration-150" >Book Appointment</button>
                                <button className="rounded-md bg-black -600 px-3.5 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-black -500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black -600 hover:text-button-300 transition-all duration-150">Join Achademy</button>
                            </div>
                        </div>
                    </div>
